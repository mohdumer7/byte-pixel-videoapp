...
module.exports = {
    ...
    host: {
        ...
        */
        ...
        users_api_endpoint: 'https://webrtc.bytepixel.com/api/v1/user/isAuth',
        users_api_secret_key: 'bytepixelweb_default_secret',
        users: [
            {
                username: 'username',
                password: 'password',
    ...
    email: {
        ...
        */
        ...
        sendTo: 'sfu.bytepixel@gmail.com',
    },
    ngrok: {
        /* 
        Ngrok
    ...
    ui: {
        /*
            Customize your bytepixel instance
        */
        brand: {
            app: {
                name: 'bytepixel SFU',
                title: 'bytepixel SFU<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
                    'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
            },
            site: {
                title: 'bytepixel SFU, Free Video Calls, Messaging and Screen Sharing',
                icon: '../images/logo.svg',
                appleTouchIcon: '../images/logo.svg',
            },
            meta: {
                description:
                    'bytepixel SFU powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
                keywords:
                    'webrtc, miro, mediasoup, mediasoup-client, self hosted, voip, sip, real-time communications, chat, messaging, meet, webrtc stun, webrtc turn, webrtc p2p, webrtc sfu, video meeting, video chat, video conference, multi video chat, multi video conference, peer to peer, p2p, sfu, rtc, alternative to, zoom, microsoft teams, google meet, jitsi, meeting',
            },
            og: {
                type: 'app-webrtc',
                siteName: 'bytepixel SFU',
                title: 'Click the link to make a call.',
                description: 'bytepixel SFU calling provides real-time video calls, messaging and screen sharing.',
                image: 'https://sfu.bytepixel.com/images/bytepixelsfu.png',
            },
            html: {
                features: true,
