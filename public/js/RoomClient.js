...
/**
 * bytepixel SFU - Client component
 *
...
const image = {
    about: '../images/bytepixel-logo.gif',
    avatar: '../images/bytepixelsfu-logo.png',
...
class RoomClient {
    ...
    selectFileToShare(peer_id, broadcast = false) {
        ...
        Swal.fire({
            allowOutsideClick: false,
            background: swalBackground,
            imageAlt: 'bytepixelsfu-file-sharing',
        ...
        if (isImageURL(this.incomingFileInfo.fileName)) {
            ...
            reader.onload = (e) => {
                Swal.fire({
                    ...
                    imageAlt: 'bytepixelsfu-file-img-download',
                    showDenyButton: true,
